package gacha_club_fla
{
   ...
   public dynamic class phonecode_12081 extends MovieClip
   {
      ...
      public function phonecode_12081()
      {
         super();
      ...
      public function updateresults() : void
      {
         ...
         parent.o1 += this.getgems;
         parent.o2 += this.getgold;
         parent.o3 += this.gettickets;
         parent.o4 += this.getbits;
         parent.enhancer1 += this.getmat1;
         parent.enhancer2 += this.getmat2;
         parent.enhancer3 += this.getmat3;
         parent.skillmoon1 += this.getmat1;
         parent.skillmoon2 += this.getmat2;
         parent.skillmoon3 += this.getmat3;
         parent.awakening1 += this.getmat1;
         parent.awakening2 += this.getmat2;
         parent.awakening3 += this.getmat3;
