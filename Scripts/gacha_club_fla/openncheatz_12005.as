package gacha_club_fla
{
   ...
   public dynamic class openncheatz_12005 extends MovieClip
   {
      ...
      public function openncheatz_12005()
      {
         super();
      ...
      public function fastbtx(evt:MouseEvent) : void
      {
         if(MovieClip(root).mutesfx == 1)
         {
            MovieClip(root).myChannel4 = MovieClip(root).clicksfx.play(0,1);
         }
         if(parent.fastmode == 1)
         {
            parent.fastmode = 2;
         }
         else
      ...
      public function minusbt7x(evt:MouseEvent) : void
      {
         ...
         if(parent.towerstage1 >= 1 && parent.towerstage1 <= 11)
         {
            parent.towerboss = 1;
         }
         else if(parent.towerstage1 >= 12 && parent.towerstage1 <= 21)
         {
            parent.towerboss = 2;
         }
         else if(parent.towerstage1 >= 22 && parent.towerstage1 <= 31)
         {
            parent.towerboss = 3;
         }
         else if(parent.towerstage1 >= 32 && parent.towerstage1 <= 41)
         {
            parent.towerboss = 4;
         }
         else if(parent.towerstage1 >= 42 && parent.towerstage1 <= 51)
         {
            parent.towerboss = 5;
         }
         else if(parent.towerstage1 >= 52 && parent.towerstage1 <= 61)
         {
            parent.towerboss = 6;
         }
         else if(parent.towerstage1 >= 62 && parent.towerstage1 <= 71)
         {
            parent.towerboss = 7;
         }
         else if(parent.towerstage1 >= 72 && parent.towerstage1 <= 81)
         {
            parent.towerboss = 8;
         }
         this.updatex();
      ...
      public function updatex() : void
      {
         ...
         this.fastbt.gotoAndStop(parent.fastmode);
         if(parent.o1 <= 0)
         {
            this.gemsx.text = "0";
         }
      ...
      public function extra() : void
      {
         ...
         while(_loc1_ <= 276)
         {
            parent["sk" + _loc1_] = parent.sk1;
            parent["pa" + _loc1_] = parent.sk1;
            _loc1_++;
         }
         parent.towerstage2 = parent.towerstage1;
         parent.towerstage3 = parent.towerstage1;
      ...
      public function accountbt7x(evt:MouseEvent) : void
      {
         ...
         parent.o3 = 30;
         parent.o4 = 40000;
         parent.enhancer1 = 25000;
         parent.enhancer2 = 9000;
         parent.enhancer3 = 5000;
         parent.skillmoon1 = 25000;
         parent.skillmoon2 = 9000;
         parent.skillmoon3 = 5000;
         parent.awakening1 = 25000;
         parent.awakening2 = 9000;
         parent.awakening3 = 5000;
         parent.storystage = 121;
         parent.towerstage1 = 41;
         parent.towerboss = 2;
         parent.trainingstage1 = 4;
         parent.shadowboss = 8;
         parent.xp = 649940;
      ...
      public function accountbt8x(evt:MouseEvent) : void
      {
         ...
         parent.storystage = 151;
         parent.towerstage1 = 51;
         parent.towerboss = 2;
         parent.trainingstage1 = 4;
      ...
      function frame2() : *
      {
         ...
         this.fastbt.addEventListener(MouseEvent.MOUSE_DOWN,this.fastbtx);
