package gacha_club_fla
{
   ...
   public dynamic class fullpic_12137 extends MovieClip
   {
      ...
      public var secretget:MovieClip;
      
      public var secretx:MovieClip;
      
      public var zackbt:MovieClip;
      
      public var zackbt2:MovieClip;
      
      public var zackbt3:MovieClip;
      
      public var zackbt4:MovieClip;
      
      public var zackbt5:MovieClip;
      
      public var zackbt6:MovieClip;
      ...
      public function fullpic_12137()
      {
         super();
         addFrameScript(0,this.frame1,1,this.frame2);
      }
      
      public function zackbtx(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
            if(parent.o24 <= 1)
            {
               if(parent.mutesfx == 1)
               {
                  parent.myChannel4 = parent.quack2sfxx.play(0,1);
               }
               this.secretget.gotoAndStop(2);
               parent.o24 = 2;
               parent.o1 += 100;
               parent.o2 += 2000;
               parent.o3 += 1;
      ...
      public function zackbt2x(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
      ...
      public function zackbt3x(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
      ...
      public function zackbt4x(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
      ...
      public function zackbt5x(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
      ...
      public function zackbt6x(evt:MouseEvent) : void
      {
         this.taptime += 1;
         if(this.taptime >= 10)
         {
      ...
      function frame2() : *
      {
         ...
         this.zackbt.visible = false;
         this.zackbt.mouseEnabled = false;
         this.zackbt2.visible = false;
         this.zackbt2.mouseEnabled = false;
         this.zackbt3.visible = false;
         this.zackbt3.mouseEnabled = false;
         this.zackbt4.visible = false;
         this.zackbt4.mouseEnabled = false;
         this.zackbt5.visible = false;
         this.zackbt5.mouseEnabled = false;
         this.zackbt6.visible = false;
         this.zackbt6.mouseEnabled = false;
         ...
         {
            this.art = "Zack6XZ";
            this.zackbt.visible = true;
            this.zackbt.mouseEnabled = true;
         }
         ...
         {
            this.art = "Ramunade";
            this.zackbt3.visible = true;
            this.zackbt3.mouseEnabled = true;
         }
         ...
         {
            this.art = "Manami Lin";
            this.zackbt5.visible = true;
            this.zackbt5.mouseEnabled = true;
         }
         ...
         {
            this.art = "Radd";
            this.zackbt6.visible = true;
            this.zackbt6.mouseEnabled = true;
         }
         ...
         {
            this.art = "PureEunoia";
            this.zackbt4.visible = true;
            this.zackbt4.mouseEnabled = true;
         }
         ...
         {
            this.art = "Crydiaa";
            this.zackbt2.visible = true;
            this.zackbt2.mouseEnabled = true;
         }
         ...
         this.zackbt.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbtx);
         this.zackbt2.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbt2x);
         this.zackbt3.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbt3x);
         this.zackbt4.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbt4x);
         this.zackbt5.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbt5x);
         this.zackbt6.addEventListener(MouseEvent.MOUSE_DOWN,this.zackbt6x);
